...
function PizzaPage() {
  const { pizzas, getPizzas, updatePizza, deletePizza } =
  ...
  const updateState = async (pizza) => {
    const updatedPizza = {
      ...
      ingredients: pizza.ingredients.map(({ ing_id, pi_portion }) => ({
        ing_id,
        pi_portion,
      })),
    };
  ...
  const handleDeletePizza = async (piz_id) => {
    const result = await Swal.fire({
      title: "¿Estás seguro de que quieres eliminar esta pizza?",
        ...
        <div>
          <div className="btn-search">
            <div className="admin-options">
              <button
                className="btn btn-crear btn-primary"
                onClick={() => {
                ...
                <div key={pizza.piz_id} className="card text-bg-light mb-3">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Total de Calorías: {pizza.total_calories}
                    </p>
          ...
          <div className="btn-search">
              ...
              <h5 className="text-center">
                {selectedPizzas.length > 0
                  ? `Mostrando ${indexOfFirstItem + 1} - ${
                      indexOfLastItem > selectedPizzas.length
                        ? selectedPizzas.length
                        : indexOfLastItem
                    } de ${selectedPizzas.length} resultados`
            ...
            <div className="text-center">
              ...
              <button
                ...
                onClick={() => setCurrentPage(currentPage + 1)}
                disabled={
                  currentPage >= Math.ceil(selectedPizzas.length / itemsPerPage)
                }
              >
